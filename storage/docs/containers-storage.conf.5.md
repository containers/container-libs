...
**rootless_storage_path**=""
  Deprecated, use **graphroot** instead. If you want to only switch the paths for all the rootless users put the config file with **graphroot** under the `storage.rootless.conf.d/` directory.
